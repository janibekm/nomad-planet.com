    ...
    var runDemoSourceCode = function() {
        ...
        if (bsElement.length) {
            ...
            /*$("<link/>", {
                rel: "stylesheet",
                type: "text/css",
                href: "http://admindesigns.com/demos/admindesigns/theme_smooth/vendor/plugins/highlight/styles/github.css"
            }).appendTo("head");
            $.getScript("http://admindesigns.com/demos/admindesigns/theme_smooth/vendor/plugins/highlight/highlight.pack.js");*/
            var modalSource = '<div class="modal fade" id="source-modal" tabindex="-1" role="dialog">  ' + '<div class="modal-dialog modal-lg"> ' + '<div class="modal-content"> ' + '<div class="modal-header"> ' + '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> ' + '<h4 class="modal-title" id="myModalLabel">File URL</h4> ' + '</div> ' + '<div class="modal-body"> ' + '<div class="highlight"> ' + '<pre> ' + '<code class="language-html" data-lang="html"></code> ' + '</pre> ' + '</div> </div> ' + '<div class="modal-footer"> ' + '<button type="button" class="btn btn-primary btn-clipboard">Select</button> ' + '</div> </div> </div> </div> </div>';
            $(modalSource).appendTo('body');
            var codeBtn = $("<div id='source-button' class='btn btn-primary btn-xs'>&lt; &gt;</div>")
            codeBtn.click(function() {
                var html = $(this).parent().find('input').val();
