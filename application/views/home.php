...
<div class="enh_page" id="enh_page">
   ...
   <section id="enh_content" class="enh_content">
    ...
    <style>
        ...
        <!-- Statistics -->
        <section class="enh_section enh_section_sml_padding enh_image_bck text-center enh_wht_txt enh_fixed" data-stellar-background-ratio="0.2" data-image="<?=base_url();?>assets/images/nuur-mori.jpg.jpg">
