...
<div class="enh_page" id="enh_page">
    ...
    <div class="enh_slider enh_image_bck enh_fixed enh_wht_txt" data-stellar-background-ratio="0.2" data-image="<?=base_url();?>assets/images/er.jpg">
        ...
        <div class="container">
            <!-- vertical text -->
            <!-- <div class="enh_slider_copyright">© AlienSoft.io 2023.</div> -->
            <!-- Slider Texts -->
            <div class="enh_slide_txt enh_slide_center_middle text-center">
                <div class="enh_slide_title enh_slide_title_middle">Nomad Planet</div>
                <p><img src="<?=base_url();?>assets/images/logo/logo.png" height="200" alt=""></p>
            </div>
            <!-- Slider Texts End -->
