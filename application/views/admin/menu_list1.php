        ...
        <div class="topbar-left">
          <ol class="breadcrumb">
            ...
            <li class="crumb-active">
              <a href="#">Мэдээний ангилалын жагсаалт</a>
            </li>
          </ol>
        </div>
         <div class="topbar-right hidden-xs hidden-sm">
          <a href="<?=base_url();?>admin/menu_add1" class="btn btn-default btn-sm light fw600 ml10">
						...
						$list .=  "<li class=\"dd-item {$class}\" data-id=\"{$row['id']}\">";
							...
							<div class=\"dd-content\">
								...
								<ul class=\"dropdown-menu\" role=\"menu\">
									<li>
									  <a href=\"".base_url()."admin/menu_edit1/".$row['id']."\"><i class=\"fa fa-wrench\"></i> Засах</a>
									</li>
									<li class=\"divider\"></li>
									<li>
										  ...
										  <div class=\"modal-dialog modal-sm\"  style=\"margin-top:10%;\">
											<div class=\"modal-content\">
											  ...
											  <div class=\"modal-footer\">
												...
												<a href=\"".base_url()."admin/menu_delete1/".$row['id']."\" class=\"btn btn-danger\">Устгах</a>
											  </div>
											</div>
										  </div>
										</div>
          ...
          <div class="row mt5">
			<div class="col-md-12"> 
			  ...
			  <div class="nestable-output hidden">
				<form action="<?=base_url();?>admin/menu_order1" id="order_menu">
