	...
	<div class="admin-form theme-primary">
	  <div class="panel heading-border panel-primary">
		<div class="panel-body bg-light">
		  <form method="post" action="<?=base_url();?>admin/banner_add" id="form-ui" enctype="multipart/form-data">
			<div class="row" id="imagePrev">
				<div class="col-md-12">
					<div class="section-divider mb40" id="spy1"><span>Видео</span></div>
					<textarea class="gui-textarea" id="summernote_iframe" name="content" placeholder="..."></textarea>
				</div>
			</div>
