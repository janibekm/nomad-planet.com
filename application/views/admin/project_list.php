...
<div class="topbar-left">
 ...
 <div class="topbar-right hidden-xs hidden-sm">
  <a href="<?=base_url();?>admin/project_add" class="btn btn-default btn-sm light fw600 ml10"><span class="fa fa-user-plus pr5"></span> Нэмэх</a>
</div>
</header>
				  ...
				  <?php echo (($post['visible']==0)?"<i class=\"fa fa-eye-slash\"></i> Харагдахгүй":"<i class=\"fa fa-eye\"></i> Харагдана")?>
				   ...
				   <ul class="dropdown-menu" role="menu">
					<li class="<?php echo (($post['visible']==1)? "active" : "") ?>">
					  <a href="<?=base_url();?>admin/project_visible/<?=$post['id']?>/1"><i class="fa fa-eye"></i> Харагдана</a>
					</li>
					<li class="<?php echo (($post['visible']==0)? "active" : "") ?>">
					  <a href="<?=base_url();?>admin/project_visible/<?=$post['id']?>/0"><i class="fa fa-eye-slash"></i> Харагдахгүй</a>
					</li>
					<li class="divider"></li>
					<li>
					  <a href="<?=base_url();?>admin/project_edit/<?=$post['id']?>"><i class="fa fa-wrench"></i> Засах</a>
					</li>
					<li class="divider"></li>
					<li>
						  ...
						  <div class="modal-dialog modal-sm"  style="margin-top:10%;">
							<div class="modal-content">
							  ...
							  <div class="modal-footer">
								...
								<a href="<?=base_url();?>admin/project_delete/<?=$post['id']?>" class="btn btn-danger">Устгах</a>
							  </div>
							</div>
						  </div>
						</div>
