...
<div class="topbar-left">
  <ol class="breadcrumb">
	...
	<li class="crumb-active"><a href="#">Slider Жагсаалт</a></li>
  </ol>
</div>
 <div class="topbar-right hidden-xs hidden-sm">
  <a href="<?=base_url();?>admin/slider_add" class="btn btn-default btn-sm light fw600 ml10"><span class="fa fa-user-plus pr5"></span> Нэмэх</a>
</div>
</header>
  ...
  <div class="panel">
	...
	<div class="panel-body pn">
	  <div class="table-responsive">
		<table id="sortthis" data-url="<?=base_url();?>admin/slider_order" class="table table-hover admin-form theme-warning tc-checkbox-1 fs13">
		  <thead>
			<tr class="bg-light">
				  ...
				  <?php echo (($post['visible']==0)?"<i class=\"fa fa-eye-slash\"></i> Харагдахгүй":"<i class=\"fa fa-eye\"></i> Харагдана")?>
				   ...
				   <ul class="dropdown-menu" role="menu">
					<li class="<?php echo (($post['visible']==1)? "active" : "") ?>">
					  <a href="<?=base_url();?>admin/slider_visible/<?=$post['id']?>/1"><i class="fa fa-eye"></i> Харагдана</a>
					</li>
					<li class="<?php echo (($post['visible']==0)? "active" : "") ?>">
					  <a href="<?=base_url();?>admin/slider_visible/<?=$post['id']?>/0"><i class="fa fa-eye-slash"></i> Харагдахгүй</a>
					</li>
					<li class="divider"></li>
					<li>
					  <a href="<?=base_url();?>admin/slider_edit/<?=$post['id']?>"><i class="fa fa-wrench"></i> Засах</a>
					</li>
					<li class="divider"></li>
					<li>
						  ...
						  <div class="modal-dialog modal-sm"  style="margin-top:10%;">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								Та <?=$post['text0'];?>-г устгах гэж байна!
							  </div>
							  <div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Болих</button>
								<a href="<?=base_url();?>admin/slider_delete/<?=$post['id']?>" class="btn btn-danger">Устгах</a>
							  </div>
							</div>
						  </div>
						</div>
