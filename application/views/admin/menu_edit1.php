	...
	<div class="admin-form theme-primary">
	  <div class="panel heading-border panel-primary">
		<div class="panel-body bg-light">
		  <form method="post" action="<?=base_url();?>admin/menu_edit1/<?=$menu['id'];?>" id="form-ui" enctype="multipart/form-data">
			...
			<div class="row form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="title" placeholder="..." value="<?=$menu['title'];?>" required />
					</div>
				</div>
				<div class="form-group">
