	  ...
	  <div class="panel heading-border panel-primary">
		<div class="panel-body">
			...
			<?php $pics = explode('*',$post['pics']);?>
				...
				<?php endif;?>
				<?php endforeach;?>-->
		  <form method="post" action="<?=base_url();?>admin/slider_edit/<?=$post['id'];?>" id="form-ui" enctype="multipart/form-data">
		  ...
		  <input type="hidden" value="<?=$post['pic'];?>" name="cover_image_url" />
			...
			<div class="row form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="text0" value="<?=htmlspecialchars($post['text1']);?>" placeholder="..." required />
					</div>
				</div>
				<div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Slider text :</label>
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="text1" value="<?=htmlspecialchars($post['text2']);?>" placeholder="..." required />
					</div>
				</div>
				<div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Slider text :</label>
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="text2" value="<?=htmlspecialchars($post['text2']);?>" placeholder="..." required />
					</div>
				</div>
				<div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Slider text :</label>
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="text3" value="<?=htmlspecialchars($post['text3']);?>" placeholder="..." required />
					</div>
				</div>
				<!--<div class="form-group">
