...
<div class="topbar-left">
  <ol class="breadcrumb">
	<li class="crumb-icon"><a href="<?=base_url();?>admin"><span class="glyphicon glyphicon-home"></span></a></li>
	 <li class="crumb-active"><a href="#">Шинэ Slider Нэмэх</a></li>
  </ol>
</div>
</header>
	...
	<div class="admin-form theme-primary">
	  <div class="panel heading-border panel-primary">
		<div class="panel-body">
		  ...
		  <form method="post" action="<?=base_url();?>admin/slider_add" id="form-ui" enctype="multipart/form-data">
		 <!-- <input type="hidden" value="" id="pics" name="pics" />-->
		  <input type="hidden" value="" id="pic" name="cover_image" />
			...
			<div class="row form-horizontal">
				...
				<div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Slider Text :</label>
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="text0" placeholder="..." required />
					</div>
				</div>
				<div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Slider Text 1 :</label>
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="text1" placeholder="..." required />
					</div>
				</div>
				<div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Slider Text 2 :</label>
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="text2" placeholder="..." required />
					</div>
				</div>
				<div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Slider Text 3 :</label>
					<div class="col-lg-8">
						<input type="text" class="gui-input" name="text3" placeholder="..." required />
					</div>
				</div>
				<!--<div class="form-group">
				...
				<!--<div class="form-group">
					...
					<div class="col-lg-8">
						<div class="panel-body pn of-h" id="summer-demo">
						  <textarea id="editor" class="summernote" name="content"></textarea>
						</div>
						<span class="input-footer">
