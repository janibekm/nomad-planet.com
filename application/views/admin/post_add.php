...
<div class="topbar-left">
  <ol class="breadcrumb">
	<li class="crumb-icon"><a href="<?=base_url();?>admin"><span class="glyphicon glyphicon-home"></span></a></li>
	 <li class="crumb-active"><a href="#">Шинэ Мэдээ Нэмэх</a></li>
  </ol>
</div>
</header>
	...
	<div class="admin-form theme-primary">
	  <div class="panel heading-border panel-primary">
		<div class="panel-body">
			...
			<!-- <form action="<?=base_url();?>admin/upload2" data-rmpath = "img/news" data-rmurl="<?=base_url();?>admin/delete_file" class="dropzone" id="dropZone2" style="min-height: 250px;">
			  <div class="fallback">
				<input name="file" type="file" multiple />
			  </div>
			</form> -->
		  <form method="post" action="<?=base_url();?>admin/post_add" id="form-ui" enctype="multipart/form-data">
		  <!-- <input type="hidden" value="" id="pics" name="pics" /> -->
		
		  <input type="hidden" value="" id="pic" name="cover_image" />

		  <input type="hidden" value="" id="bigpic" name="bigpic_image" />
		  <div class="row form-horizontal">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<label class="field prepend-icon">
								<input type="text" name="bigpic_image_url" id="imgUrl" class="gui-input" placeholder="Зурагны холбоос" />
					...
					<div class="row table-layout table-clear-xs">
					  <div class="col-xs-12 col-sm-8">
						<div class="img-container pv10">
						  ...
						  <!--<img data-src="holder.js/<?=$width;?>x<?=$height;?>/text:<?=$width;?>px : <?=$height;?>px" />-->
						</div>
					  </div>
			...
			<div class="row form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-lg-4">
						<select name="order" style="display: none;" id="onts" tabindex="-1" class="select2-single select2-primary form-control">
							<option value="1" selected="selected">1 т</option>
							<option value="2">2 т</option>
							<option value="3">3 т</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-4">
						<select name="mostread" style="display: none;" id="onts" tabindex="-1" class="select2-single select2-primary form-control">
							<option value="0" selected="selected">Гаргахгүй</option>
							<option value="1">1 т</option>
							<option value="2">2 т</option>
							<option value="3">3 т</option>
							<option value="3">3 т</option>
						</select>
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<label class="field prepend-icon">
							<textarea class="gui-textarea summernote_init" id="comment" name="description" placeholder="..."></textarea>
						</label>
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<div class="panel-body pn of-h" id="summer-demo">
								<textarea id="editor" class="summernote ckeditor" name="content"></textarea>
						</div>
						<span class="input-footer">
