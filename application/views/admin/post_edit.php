	...
	<div class="admin-form theme-primary">
	  <div class="panel heading-border panel-primary">
		<div class="panel-body">
			...
			<form action="<?=base_url();?>admin/upload2" data-rmpath = "img/news" data-rmurl="<?=base_url();?>admin/post_pics/<?=$post['id'];?>" class="dropzone" id="dropZone2" style="min-height: 250px;">
			  <div class="fallback">
			...
			<?php $pics = explode('*',$post['pics']);?>
				...
				<?php endif;?>
				<?php endforeach;?> -->
		  <form method="post" action="<?=base_url();?>admin/post_edit/<?=$post['id'];?>" id="form-ui" enctype="multipart/form-data">
		  ...
		  <input type="hidden" value="<?=$post['bigpic'];?>" name="bigpic_image_url" />
		  <input type="hidden" value="" name="bigpic_image" />
		  <div class="row form-horizontal">
			<div class="col-md-6">
					<div class="section-divider mb40" id="spy1"><span>Онцлох зураг</span></div>
					<div class="fileupload fileupload-new" data-provides="fileupload">
						<div class="row">
							<div class="col-md-12">
							  <div class="fileupload-preview thumbnail mb20">
								 <?php if($post['bigpic']==="" || $post['bigpic']===null):?>
								 <!-- <img id="previewImg" data-src="holder.js/740x440/text:740px : 440px" /> -->
								 <img id="previewImg" data-src="holder.js/625x400/text:625px : 400px" />
								 <?php else:?>
								 <img id="previewImg" src="../../<?=$post['bigpic'];?>" />
								 <?php endif;?>
							  </div>
							</div>
							<div class="col-md-4">
								<span class="btn btn-system btn-file btn-block mb20">
									<span class="fileupload-new">Сонгох</span>
									<span class="fileupload-exists">Өөрчлөх</span>
									<input name="bigpic_image" type="file" />
								</span>
								<label class="field prepend-icon">
									<input type="text" name="bigpic_image_url" value="<?=$post['bigpic'];?>" id="imgUrl" class="gui-input" placeholder="Зурагны холбоос" />
									<label for="firstname" class="field-icon"><i class="fa fa-image"></i></label>
								</label>
							</div>
						</div>
					</div>
				...
				<div class="col-md-6">
						<p> Онцлох 1 т бол том зураг 625x400 <p>
						<p> Онцлох 2, 3 т бол том зураг 300x400 <p>
				</div>
			</div>
			...
			<div class="row form-horizontal">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label">Онцлох</label>
					<div class="col-lg-8">
						<select name="ontsloh" style="display: none;" id="onts" tabindex="-1" class="select2-single select2-primary form-control">
							<option value="0" <?=$post["ontsloh"] == "0" ? "selected" : "" ;?>>Үгүй</option>
							<option value="1" <?=$post["ontsloh"] == "1" ? "selected" : "" ;?>>Тийм</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-3 control-label">Онцлох дараалал</label>
					<div class="col-lg-8">
						<select name="order" style="display: none;" id="onts" tabindex="-1" class="select2-single select2-primary form-control">
							<option value="1" <?=$post["order"] == "1" ? "selected" : "" ;?>>1 т</option>
							<option value="2" <?=$post["order"] == "2" ? "selected" : "" ;?>>2 т</option>
							<option value="3" <?=$post["order"] == "3" ? "selected" : "" ;?>>3 т</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label class="col-lg-3 control-label">Их уншсан дараалал</label>
					<div class="col-lg-8">
						<select name="mostread" style="display: none;" id="onts" tabindex="-1" class="select2-single select2-primary form-control">
							<option value="0" <?=$post["mostread"] == "0" ? "selected" : "" ;?>>Гаргахгүй</option>
							<option value="1" <?=$post["mostread"] == "1" ? "selected" : "" ;?>>1 т</option>
							<option value="2" <?=$post["mostread"] == "2" ? "selected" : "" ;?>>2 т</option>
							<option value="3" <?=$post["mostread"] == "3" ? "selected" : "" ;?>>3 т</option>
							<option value="3" <?=$post["mostread"] == "4" ? "selected" : "" ;?>>4 т</option>
						</select>
					</div>
				</div>
				<div class="form-group">
